#!/usr/bin/env python3
"""
Embedding Analysis Script for GENA-LM

This script:
1. Extracts embeddings from a trained/pretrained GENA-LM model for sequences in CSV files
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Extract embeddings and perform embedding analysis for GENA-LM"
    )
    parser.add_argument(
        "--csv_dir",
        type=str,
...
def main():
    ...
    print("\n" + "=" * 60)
    print("GENA-LM Embedding Analysis")
    print("=" * 60)
    ...
    if os.path.exists(embeddings_path):
        ...
        # GENA-LM models use ESM architecture - load via AutoModelForMaskedLM
    ...
    # Save results — MERGE into any existing file so a pretrained-only re-run
