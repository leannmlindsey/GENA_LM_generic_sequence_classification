...
# genome-wide CSV — GENA-LM (bigbird | moderngena). Reuses the saved probe
# artifacts in REPL_OUTPUT_DIR/embedding/<variant>; writes lp/ and nn/ subdirs
# under REPL_OUTPUT_DIR/genome_wide_heads/<variant>/.
#
# conda: this job self-activates gena_lm (matching lambda_embedding_job.sh).
#
...
# --- conda (self-activate, as in lambda_embedding_job.sh) ---
