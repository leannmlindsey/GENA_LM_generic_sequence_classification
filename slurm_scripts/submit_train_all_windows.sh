...
echo ""
echo "When ALL jobs for this variant finish, evaluate the checkpoints with the"
echo "generic inference scripts (run_inference.sh / wrapper_run_inference.sh), or"
echo "use the self-contained LAMBDA pipeline in slurm_scripts/lambda_replication/."
